/*
    Script: 01_io_file_interval.sql
    Proposito:
        Cuarto paso cuando los waits o sesiones apuntan a I/O.
        Mide actividad de I/O por archivo en un intervalo corto.

    Cuando usar:
        Cuando waits como PAGEIOLATCH, WRITELOG, IO_COMPLETION o sesiones
        con muchas lecturas/escrituras apuntan a presion de almacenamiento.

    Como usar:
        1. Ajustar @sample_seconds segun la ventana que se quiera observar.
        2. Ejecutar durante el incidente.
        3. Revisar read_mb_delta, write_mb_delta, avg_read_ms_interval
           y avg_write_ms_interval.

    Precauciones:
        El script espera el intervalo configurado con WAITFOR DELAY.
*/
